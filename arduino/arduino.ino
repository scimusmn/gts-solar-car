...
#define LEDRingPIN 7
#define HallLinePIN 6
// #define HallBeforeLinePIN 1
#define MotorPIN 10
#define EncoderPIN 11
#define LightRelayPIN 3
#define HardStartBtn 4
#define HardBtnLED 5
#define MedStartBtn 8
#define MedBtnLED 9
#define EasyStartBtn 12
#define EasyBtnLED 13
#define EasyTimePot A0
#define HardTimePot A2
